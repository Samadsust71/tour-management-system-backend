...
const transporter = nodemailer_1.default.createTransport({
    ...
    connectionTimeout: Number(env_1.envVars.SMTP_CONNECTION_TIMEOUT) || undefined,
});
...
const sendEmail = (_a) => __awaiter(void 0, [_a], void 0, function* ({ to, subject, templateName, templateData, attachments, }) {
    try {
        ...
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "Email error occurred");
    }
});
