...
const getInvoiceDownloadUrl = (paymentId, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (payment.booking.user.toString() !== userId) {
        throw new AppError_1.default(http_status_codes_1.default.FORBIDDEN, "You are not authorized to access this invoice");
    }
