...
const resetPassword = (payload, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (yield bcryptjs_1.default.compare(payload.newPassword, isUserExist.password)) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "New password cannot be the same as the old password");
    }
    const hashedPassword = yield bcryptjs_1.default.hash(payload.newPassword, Number(env_1.envVars.SALT_VALUE));
...
const setPassword = (userId, plainPassword) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user.password && user.auths.some(auth => auth.provider === "google")) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "You have already set a password for your account. Please use the 'Change Password' option.");
    }
    const hashedPassword = yield bcryptjs_1.default.hash(plainPassword, Number(env_1.envVars.SALT_VALUE));
    const credentialProvider = { provider: "credentials", providerId: user.email };
...
const changePassword = (oldPassword, newPassword, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    user.password = yield bcryptjs_1.default.hash(newPassword, Number(env_1.envVars.SALT_VALUE));
    user.save();
});
